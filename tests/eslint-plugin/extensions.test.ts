...
run({
  ...
  valid: [
    ...
    { code: 'import path from "path"', options: ['never'] },
    { code: 'import path from "path"', options: ['always'] },
    { code: 'import thing from "./fake-file.js"', options: ['always'] },
    { code: 'import thing from "non-package"', options: ['never'] },
  ...
  invalid: [
    {
      ...
      errors: [{
        message: 'Missing file extension for "./typescript-declare"',
      }],
      options: [
        'always',
        { ts: 'never', tsx: 'never', js: 'never', jsx: 'never' },
